...
{[assign_block var="phyaddr"]}{[link table='physician' link=$rxphy field='phyaddr1a']}, {[link table='physician' link=$rxphy field='phycitya']}, {[link table='physician' link=$rxphy field='phycitya']} {[link table='physician' link=$rxphy field='phyzipa']}{[/assign_block]}
...
\framebox[5in]{
	\parbox{4.8in}{
		\begin{center}
			...
			\textsl{{[if $phyphone]}Phone {[$phyphone|texize]}{[/if]} {[if $phyfax]}Fax {$phyfax|texize[]}{[/if]}}
...
%				\textbf{Medication}  & \parbox{3in}{{\large {[$rxform|texize]} {[$rxdrug|texize]} {[$rxsize|texize]} {[$rxunit|texize]}}} \\
				\textbf{Medication}  & {\large {[$rxdrug|texize]} {[$rxunit|texize]} } \\
