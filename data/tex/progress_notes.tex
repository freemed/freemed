...
{[method namespace='org.freemedsoftware.api.PatientInterface.ToText' param0=$pnotespat var='patient_name']}
{[method namespace='org.freemedsoftware.core.Physician.fullName' param0=$pnotesdoc var='provider_name']}
...
\begin{center}
        ...
        {\relsize{-1}\textsl{{[$provider_name|texize]}}} \\
...
% {[method namespace='org.freemedsoftware.core.Physician.fullName' param0=$pnotesdoc|texize]} \\
\begin{tabular}{ll}
NAME:	&	{[$patient_name|texize]}	\\
