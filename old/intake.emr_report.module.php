...
LoadObjectDependency('FreeMED.EMRReportModule');

class IntakeReportModule extends EMRReportModule {
	...
	var $PACKAGE_MINIMUM_VERSION = '0.6.0';
		...
		$this->EMRReportModule($nullvar);
        } // end function IntakeReportModule
