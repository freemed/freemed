...
public class DiagnosisFamilyEntry extends EntryScreenInterface {

	public DiagnosisFamilyEntry() {
		initWidget(ui);
	}
	...
	protected void buildForm() {
		ui.addWidget("dfname", "Diagnosis Family", WidgetType.TEXT, "20", null);
		ui.addWidget("dfdescrip", "Description", WidgetType.TEXT, "50", null);
	}

	protected String getModuleName() {
		return "DiagnosisFamily";
	}
