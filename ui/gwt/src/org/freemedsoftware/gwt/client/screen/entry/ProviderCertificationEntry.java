...
public class ProviderCertificationEntry extends EntryScreenInterface {

	public ProviderCertificationEntry() {
		initWidget(ui);
	}
	...
	protected void buildForm() {
		ui.addWidget("degdegree", "Degree Abbreviation", WidgetType.TEXT, "10",
				null);
		ui.addWidget("degname", "Degree Name", WidgetType.TEXT, "50", null);
	}
