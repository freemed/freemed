...
public class TypeOfServiceEntry extends EntryScreenInterface {

	public TypeOfServiceEntry() {
		initWidget(ui);
	}
	...
	protected void buildForm() {
		ui.addWidget("tosname", "Type of Service", WidgetType.TEXT, "20", null);
		ui.addWidget("tosdescrip", "Description", WidgetType.TEXT, "50", null);
	}
