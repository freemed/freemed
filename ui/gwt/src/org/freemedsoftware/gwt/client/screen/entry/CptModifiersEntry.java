...
public class CptModifiersEntry extends EntryScreenInterface {

	public CptModifiersEntry() {
		initWidget(ui);
	}
	...
	protected void buildForm() {
		ui.addWidget("cptmod", "Modifier", WidgetType.TEXT, "5", null);
		ui.addWidget("cptmoddescrip", "Description", WidgetType.TEXT, "50",
				null);
	}
