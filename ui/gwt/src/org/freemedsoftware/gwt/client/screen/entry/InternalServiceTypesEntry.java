...
public class InternalServiceTypesEntry extends EntryScreenInterface {

	public InternalServiceTypesEntry() {
		initWidget(ui);
	}
	...
	protected void buildForm() {
		ui.addWidget("intservtype", "Type", WidgetType.TEXT, "50", null);
	}

	protected String getModuleName() {
		return "InternalServiceTypes";
	}
