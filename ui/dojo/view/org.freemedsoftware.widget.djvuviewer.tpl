...
<tr><td align="center">
<input type="button" id="djvuPagePrevTop_<!--{$id|escape}-->" value=" &lt; " onClick="djvuChangePage(currentDjvuPage - 1);" disabled="disabled" />
<span id="djvuCurrentPageTop_<!--{$id|escape}-->">1</span> of <span id="djvuTotalPageTop_<!--{$id|escape}-->">1</span>
<input type="button" id="djvuPageNextTop_<!--{$id|escape}-->" value=" &gt; " onClick="djvuChangePage(currentDjvuPage + 1);" disabled="disabled" />
</td>
</tr>
<tr>
...
<tr><td align="center">
<input type="button" id="djvuPagePrevBottom_<!--{$id|escape}-->" value=" &lt; " onClick="djvuChangePage(currentDjvuPage - 1);" disabled="disabled" />
<span id="djvuCurrentPageBottom_<!--{$id|escape}-->">1</span> of <span id="djvuTotalPageBottom_<!--{$id|escape}-->">1</span>
<input type="button" id="djvuPageNextBottom_<!--{$id|escape}-->" value=" &gt; " onClick="djvuChangePage(currentDjvuPage + 1);" disabled="disabled" />
</td>
</tr>
</table>
<script language="javascript">
	...
	function djvuChangePage( page ) {
		...
		document.getElementById('djvuViewer_<!--{$id|escape}-->').src = '<!--{$base_uri}-->/relay.php/json/org.freemedsoftware.module.<!--{$type|escape:'url'}-->.GetDocumentPage?param0=<!--{$id|escape:'url'}-->&param1=' + currentDjvuPage;
