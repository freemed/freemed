	...
	var m = {
		...
		initialLoad: function ( ) {
			...
			dojo.io.bind({
				...
				url: "<!--{$relay}-->/org.freemedsoftware.module.patientstatus.GetRecord",
		...
		submit: function ( ) {
			...
			if (m.validate( myContent )) {
				dojo.io.bind({
					...
					url: "<!--{$relay}-->/org.freemedsoftware.module.patientstatus.<!--{if $id}-->mod<!--{else}-->add<!--{/if}-->",
					load: function ( type, data, evt ) {
