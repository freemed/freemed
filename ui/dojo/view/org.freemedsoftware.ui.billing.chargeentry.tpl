...
<tr>
	<td colspan="3">
		<div class="tableContainer">
                <table dojoType="FilteringTable" id="chargeEntrySearch" widgetId="chargeEntrySearch" headClass="fixedHeader" tbodyClass="scrollContent" enableAlternateRows="true" rowAlterateClass="alternateRow" valueField="scheduler_id" border="0" multiple="no">
			<thead>
				<tr>
