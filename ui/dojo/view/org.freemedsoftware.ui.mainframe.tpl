	...
	>
		...
		<div id="freemedContent" dojoType="ContentPane" executeScripts="true" sizeMin="20" sizeShare="80" cacheContent="false" adjustPaths="false">
			<div id="freemedTabContainer" dojoType="TabContainer" labelPosition="top" style="width: 100%; height: 100%;">
				<div id="freemedTabDashboard" dojoType="ContentPane" href="<!--{$controller}-->/org.freemedsoftware.controller.dashboard" loadingMessage="<!--{$paneLoading|escape}-->" adjustPaths="false" cacheContent="false" executeScripts="true" label="<!--{t|escape:'javascript'}-->Dashboard<!--{/t}-->" closable="false"></div>
				<div id="freemedWorkspace1" dojoType="ContentPane" adjustPaths="false" cacheContent="false" executeScripts="true" closable="true" label="<!--{t|escape:'javascript'}-->Workspace<!--{/t}--> 1" loadingMessage="<!--{$paneLoading|escape}-->"></div>
