	...
	var m = {
		...
		initialLoad: function ( ) {
			...
			dojo.io.bind({
				...
				url: "<!--{$relay}-->/org.freemedsoftware.module.placeofservice.GetRecord",
		...
		submit: function ( ) {
			...
			if (m.validate( myContent )) {
				dojo.io.bind({
					...
					url: "<!--{$relay}-->/org.freemedsoftware.module.placeofservice.<!--{if $id}-->mod<!--{else}-->add<!--{/if}-->",
					load: function ( type, data, evt ) {
