...
HTMLArea.Config = function () {
	...
	this.editorURL = "lib/template/default/htmlarea/";
...
HTMLArea.loadPlugin = function(pluginName) {
	var editorurl = 'lib/template/default/htmlarea/';
	if (typeof _editor_url != "undefined") {
...
HTMLArea.prototype.execCommand = function(cmdID, UI, param) {
	...
	switch (cmdID.toLowerCase()) {
	    ...
	    case "showhelp" : window.open("lib/template/default/htmlarea/reference.html", "ha_help"); break;
