...
dojo.io._bindQueue=[];
dojo.io._queueBindInFlight=false;
dojo.require('dojo.json'); /* #2255 patch from jeff@freemedsoftware.org */
...
}else if (typeof(_170) == 'object') { /* #2255 patch from jeff@freemedsoftware.org */
_16d(dojo.json.serialize(_170));
}else{
_16d(_170);
}
}
