<?
# function a_acta_asistentes_copia
...
function a_acta_asistentes_copia($string_column, $array_row)
{
...
try
{
	...
	INNER JOIN sch_rpsdatos.sn_tcarg on (sch_rpsdatos.sn_tdatbas.datb_carg = sch_rpsdatos.sn_tcarg.carg_carg) where c_nref=$string_column and m_estatus_asistente_ac='C'";
