...
// Ver:		$Id: jpgraph_bar.php,v 1.26 2002/03/31 22:22:20 aditus Exp $
//
...
// PUBLIC METHODS	
	...
	switch( $style ) {	
	    ...
	    default:
		adie("JpGraph Error: Unknown gradient style (=$style).");
		break;
	}
    }
...
class BarPlot extends Plot {
    var $width=1; // in percent of major ticks
...
// PUBLIC METHODS	
	...
	adie("JpGraph Error: Deprecated function SetYStart. Use SetYMin() instead.");
    }
