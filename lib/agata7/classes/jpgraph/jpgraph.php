...
// Ver:		$Id: jpgraph.php,v 1.61 2002/04/20 18:33:18 aditus Exp $
//
...
// PUBLIC METHODS	
	...
	$this->xgrid = new JGrid($this->xaxis);
	$this->ygrid = new JGrid($this->yaxis);	
	$this->ygrid->Show();			
    }
	...
	$this->y2grid = new JGrid($this->y2axis);							
    }
...
// PUBLIC METHODS	
	...
	if( $min_step_abs==0 || $maj_step_abs==0 ) 
	    JpGraphError::Raise(" A plot has an illegal scale. This could for example be\nthat you are trying to use text autoscaling to draw a line plot with only one\npoint or similair abnormality (a line needs two points!).\n");
