...
class GWTPHPContext {
	...
	private function initClassLoader(AbstractClassLoader $classLoader = null) {
		...
		if ($this->getGWTPHPRootDir() != null) { 
			...
			$classLoader->addClassPath($this->getGWTPHPRootDir().GWTPHPContext::$GWTPHP_MAPS_FOLDER);
		}
	...
	private function initClassMapLoader(AbstractClassMapLoader $classMapLoader = null) {
		...
		if ($this->getGWTPHPRootDir() != null) { 
			$classMapLoader->addClassMapPath($this->getGWTPHPRootDir().GWTPHPContext::$GWTPHP_MAPS_FOLDER);
		}
