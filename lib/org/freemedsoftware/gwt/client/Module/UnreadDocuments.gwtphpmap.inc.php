...
$gwtphpmap = array (
	array (
		  'className' => 'org.freemedsoftware.gwt.client.Module.UnreadDocuments'
		, 'mappedBy' => 'org.freemedsoftware.module.UnreadDocuments'
		, 'methods' => array (
			...
			//
			, array (
				  'name' => 'MoveToAnotherProvider'
				, 'mappedName' => 'MoveToAnotherProvider'
			...
			//
			, array (
				  'name' => 'ReviewIntoRecord'
				, 'mappedName' => 'ReviewIntoRecord'
				, 'returnType' => 'java.lang.Boolean'
				, 'params' => array (
					  array ( 'type' => 'java.lang.Integer' )
				)
