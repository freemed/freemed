...
class LettersTemplates extends MaintenanceModule {
	...
	var $record_name = "Letters Templates";
	var $table_name = "letters_templates";

	function LettersTemplates () {
	...
	} // end constructor LettersTemplates
	...
	function form () {
		...
		".html_form::form_table(array(
			...
			__("Letter Subject") =>
			html_form::text_widget('ltsubject', 25, 150),
	...
	function picklist ($varname, $formname) {
		...
		"class=\"button\"/> ".
		$add;
	} // end function LettersTemplates->picklist
