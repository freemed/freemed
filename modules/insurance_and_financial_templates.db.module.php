...
class InsuranceAndFinancialTemplates extends MaintenanceModule {
	var $MODULE_NAME = 'Insurance And Financial Templates';
	...
	var $record_name = "Insurance And Financial Templates";
	var $table_name = "insfinancial_templates";

	function InsuranceAndFinancialTemplates () {
	...
	function picklist ($varname, $formname) {
		$query = "SELECT * FROM ".$this->table_name." ".
			"WHERE ltphy='".$GLOBALS['this_user']->user_phy."' OR ltphy=0 ".
			"ORDER BY ltname";
...
} // end class InsuranceAndFinancialTemplates

register_module('InsuranceAndFinancialTemplates');
