...
class PathologyReportImages extends EMRModule {

	var $MODULE_NAME = "Pathology Reports";
	...
	var $record_name   = "Pathology Reports";
	var $table_name    = "images";
	var $patient_field = "imagepat";
	var $order_by      = "imagedt DESC";
	var $summary_conditional = "imagetype = 'pathology'";

	function PathologyReportImages () {
		...
		$this->EMRModule();
	} // end constructor PathologyReportImages
	...
	function view ($condition = false) {
		...
		$display_buffer .= "\n<p/>\n";
	} // end function PathologyReportImages->view()
...
} // end of class PathologyReportImages

register_module ("PathologyReportImages");
