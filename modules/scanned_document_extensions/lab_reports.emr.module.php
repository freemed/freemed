...
class LabReportImages extends EMRModule {

	var $MODULE_NAME = "Lab Reports";
	...
	var $record_name   = "Lab Reports";
	var $table_name    = "images";
	var $patient_field = "imagepat";
	var $order_by      = "imagedt";
	var $summary_conditional = "imagetype = 'lab_report'";

	function LabReportImages () {
		...
		$this->EMRModule();
	} // end constructor LabReportImages
	...
	function view ($condition = false) {
		...
		$display_buffer .= "\n<p/>\n";
	} // end function LabReportImages->view()
...
} // end of class LabReportImages

register_module ("LabReportImages");
