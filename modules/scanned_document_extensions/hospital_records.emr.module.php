...
class HospitalRecordsImages extends EMRModule {

	var $MODULE_NAME = "Hospital Records";
	...
	var $record_name   = "Hospital Records";
	var $table_name    = "images";
	var $patient_field = "imagepat";
	var $order_by      = "imagedt";
	var $summary_conditional = "imagetype = 'hospital'";

	function HospitalRecordsImages () {
		// Define variables for EMR summary
		$this->summary_vars = array (
			__("Date")        =>	"my_date",
			__("Provider")    =>	"imagephy:physician",
		...
		$this->EMRModule();
	} // end constructor HospitalRecordsImages
...
} // end class HospitalRecordsImages

register_module ("HospitalRecordsImages");
