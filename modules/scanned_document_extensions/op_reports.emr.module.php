...
class OpReportImages extends EMRModule {

	var $MODULE_NAME = "Op Reports";
	...
	var $record_name   = "Op Reports";
	var $table_name    = "images";
	var $patient_field = "imagepat";
	var $order_by      = "imagedt";
	var $summary_conditional = "imagetype = 'op_report'";

	function OpReportImages () {
		// Define variables for EMR summary
		$this->summary_vars = array (
			__("Date")        =>	"imagedt",
			__("Category")    =>	"imagecat",
			__("Physician")    =>	"imagephy:physician",
		...
		$this->EMRModule();
	} // end constructor OpReportImages
...
} // end of class OpReportImages

register_module ("OpReportImages");
