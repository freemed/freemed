...
class ReferringNotesImages extends EMRModule {

	var $MODULE_NAME = "Referring Doctors Notes";
	...
	var $record_name   = "Referring Doctors Notes";
	var $table_name    = "images";
	var $patient_field = "imagepat";
	var $order_by      = "imagedt";
	var $summary_conditional = "imagetype = 'referral'";

	function ReferringNotesImages () {
		...
		$this->EMRModule();
	} // end constructor ReferringNotesImages
...
} // end of class ReferringNotesImages

register_module ("ReferringNotesImages");
