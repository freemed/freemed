...
class HistoricalRecordsImages extends EMRModule {

	var $MODULE_NAME = "Historical Records";
	...
	var $record_name   = "Historical Records";
	var $table_name    = "images";
	var $patient_field = "imagepat";
	var $order_by      = "imagedt";
	var $summary_conditional = "imagetype = 'historical'";

	function HistoricalRecordsImages () {
		...
		$this->EMRModule();
	} // end constructor HistoricalRecordsImages
...
} // end class HistoricalRecordsImages

register_module ("HistoricalRecordsImages");
