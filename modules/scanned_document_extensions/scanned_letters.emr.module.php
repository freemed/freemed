...
class ScannedLetters extends EMRModule {

	var $MODULE_NAME = "Letters (Scanned)";
	...
	var $record_name   = "Scanned Letters";
	var $table_name    = "images";
	var $patient_field = "imagepat";
	var $order_by      = "imagedt";
	var $summary_conditional = "imagetype = 'letters'";

	function ScannedLetters () {
		...
		$this->EMRModule();
	} // end constructor ScannedLetters
...
} // end of class ScannedLetters

register_module ("ScannedLetters");
