...
class RadiologyReports extends EMRModule {

	var $MODULE_NAME = "Radiology Reports";
	...
	var $record_name   = "Radiology Reports";
	var $table_name    = "images";
	var $patient_field = "imagepat";
	var $order_by      = "imagedt";
	var $summary_conditional = "imagetype = 'radiology'";
	...
	function RadiologyReports () {
		...
		$this->EMRModule();
	} // end constructor RadiologyReports
	...
	function view ($condition = false) {
		...
		$display_buffer .= "\n<p/>\n";
	} // end function RadiologyReports->view()
...
} // end of class RadiologyReports

register_module ("RadiologyReports");
