...
if (($action=="addform") AND ($separate_add_section)) {
  ...
  echo "
    ...
    <$STDFONT_B>$Type_of_Service_Name<$STDFONT_E>
    <INPUT TYPE=TEXT NAME=tosname SIZE=20 MAXLENGTH=75
     VALUE=\"$tosname\">
    <BR>

    <$STDFONT_B>$Type_of_Service_Description<$STDFONT_E>
  ...
  if ($result) {
    ...
    echo "
      ...
      <TD VALIGN=CENTER><FORM ACTION=\"$page_name\"
       ><INPUT TYPE=HIDDEN NAME=\"action\" VALUE=\"add\">
       <INPUT TYPE=TEXT NAME=\"tosname\" SIZE=20
        MAXLENGTH=75></TD>
      <TD VALIGN=CENTER>
       <INPUT TYPE=TEXT NAME=\"tosdescrip\" SIZE=25
        MAXLENGTH=200></TD>
    ...
    echo "
      ...
      <TD ALIGN=LEFT>&nbsp;</TD>
      <TD WIDTH=30%>&nbsp;</TD>
      <TD ALIGN=RIGHT><A HREF=\"$_ref?_$_auth\"
       ><FONT COLOR=#ffffff FACE=\"Arial, Helvetica, Verdana\"
       SIZE=-1><B>$RETURN_TO_MENU</B></FONT></A></TD>
      </TR></TABLE>
    ";
